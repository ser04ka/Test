...
Instance.new("Frame", TopBar).Size = UDim2.new(1, 0, 0, 2)
TopBar.Frame.Position = UDim2.new(0, 0, 1, 0)
TopBar.Frame.BackgroundColor3 = Color3.fromRGB(255, 180, 30)

local TitleLabel = Instance.new("TextLabel")
TitleLabel.Size = UDim2.new(0, 200, 0, 25)
TitleLabel.Position = UDim2.new(0, 10, 0.5, -12)
...
Home.Button.TextSize = 14

-- ====== HOME ======
local HomeGroup = Instance.new("Frame")
HomeGroup.Size = UDim2.new(1, -16, 0, 50)
HomeGroup.BackgroundTransparency = 1
HomeGroup.Parent = Home.Page

local UptimeLabel = Instance.new("TextLabel")
UptimeLabel.Size = UDim2.new(1, 0, 0, 24)
...
SpeedGroup.Parent = Settings.Page
